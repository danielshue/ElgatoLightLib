...
namespace ElgatoLightLib
{
    ...
    public class ElgatoLightMgr : IElgatoLightMgr
    {
        ...
        /// </summary>
        /// <remarks>
        /// Elgato EveKey LightService would be "_hap._tcp.local."
        /// </remarks>
        private static readonly string BonjourDiscoveryElgatoKeyLightService = "_elg._tcp.local.";

        /// <summary>
        /// Template used for the Elgato Keylight Endpoint.
        /// </summary>
        private static readonly string AccessoryInfoEndPointTemplate = @"http://{0}:{1}/elgato/accessory-info";
        ...
        /// <returns></returns>
        private static async Task<ElgatoLight> RetrieveKeyLightInfoAsync(string ipaddress, string name, int port)
        {
